...
// SELECT * FROM gbook ORDER BY id DESC LIMIT 0(시작레코드), 5(가져올 레코드수)
module.exports = (obj) => {
	if(!obj.list) obj.list = 3;	// 한페이지에 나타날 목록의 갯수 // obj.list = obj.list || 3;
	...
	if(obj.page > 1) obj.prev = obj.page - 1;
	if(obj.page < obj.totalPage) obj.next = obj.page + 1;
